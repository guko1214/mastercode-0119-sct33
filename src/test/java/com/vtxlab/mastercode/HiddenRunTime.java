...
public class HiddenRunTime {
  ...
  void score() {
    ...
    System.out.println("Q1 Performance Bonus=" + q1Bonus);
    System.out.println("Q2 Performance Bonus=" + q2Bonus);
    System.out.println("Q3 Performance Bonus=" + q3Bonus);
  ...
  void testTimeComplexity_q2_Level1() {
    ...
    assertTimeout(Duration.ofMillis(280), () -> {
